...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Tue Dec 20 09:13:39 CET 2022
...
current_design edge_detector

create_clock -name "clk" -add -period 30.0 -waveform {0.0 15.0} [get_ports clk]
set_load -pin_load 1.0 [get_ports edges]
set_clock_gating_check -setup 0.0 
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports clk]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports input]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports edges]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports clk]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports input]
