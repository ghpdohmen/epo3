...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Tue Dec 20 09:14:36 CET 2022
...
current_design counter25mhz

create_clock -name "clk" -add -period 30.0 -waveform {0.0 15.0} [get_ports clk]
set_load -pin_load 1.0 [get_ports {count_out[11]}]
set_load -pin_load 1.0 [get_ports {count_out[10]}]
set_load -pin_load 1.0 [get_ports {count_out[9]}]
set_load -pin_load 1.0 [get_ports {count_out[8]}]
set_load -pin_load 1.0 [get_ports {count_out[7]}]
set_load -pin_load 1.0 [get_ports {count_out[6]}]
set_load -pin_load 1.0 [get_ports {count_out[5]}]
set_load -pin_load 1.0 [get_ports {count_out[4]}]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[11]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[10]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[9]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[8]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[4]}]
