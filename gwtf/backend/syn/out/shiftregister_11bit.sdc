...
current_design shiftregister_11bit

create_clock -name "clk" -add -period 30.0 -waveform {0.0 15.0} [get_ports clk]
set_load -pin_load 1.0 [get_ports {data_out[10]}]
set_load -pin_load 1.0 [get_ports {data_out[9]}]
set_load -pin_load 1.0 [get_ports {data_out[8]}]
set_load -pin_load 1.0 [get_ports {data_out[7]}]
set_load -pin_load 1.0 [get_ports {data_out[6]}]
set_load -pin_load 1.0 [get_ports {data_out[5]}]
set_load -pin_load 1.0 [get_ports {data_out[4]}]
set_load -pin_load 1.0 [get_ports {data_out[3]}]
set_load -pin_load 1.0 [get_ports {data_out[2]}]
set_load -pin_load 1.0 [get_ports {data_out[1]}]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {data_out[9]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {data_out[8]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {data_out[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {data_out[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {data_out[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {data_out[4]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {data_out[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {data_out[2]}]
