...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Tue Dec 20 09:15:57 CET 2022
...
current_design timebase

create_clock -name "clk" -add -period 30.0 -waveform {0.0 15.0} [get_ports clk]
set_load -pin_load 1.0 [get_ports {count_out[3]}]
set_load -pin_load 1.0 [get_ports {count_out[2]}]
set_load -pin_load 1.0 [get_ports {count_out[1]}]
set_load -pin_load 1.0 [get_ports {count_out[0]}]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {count_out[0]}]
