...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Thu Dec 22 13:46:55 CET 2022
...
current_design sendFSM

create_clock -name "clk" -add -period 30.0 -waveform {0.0 15.0} [get_ports clk]
set_load -pin_load 1.0 [get_ports clkTrans]
set_load -pin_load 1.0 [get_ports dataTrans]
set_load -pin_load 1.0 [get_ports timebaseRst]
set_load -pin_load 1.0 [get_ports {dataToReg[8]}]
set_load -pin_load 1.0 [get_ports {dataToReg[7]}]
set_load -pin_load 1.0 [get_ports {dataToReg[6]}]
set_load -pin_load 1.0 [get_ports {dataToReg[5]}]
set_load -pin_load 1.0 [get_ports {dataToReg[4]}]
set_load -pin_load 1.0 [get_ports {dataToReg[3]}]
...
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports actBit]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports reset]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[11]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[10]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[9]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[8]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[7]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[6]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[5]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[4]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[3]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[2]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[1]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {countIn[0]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports clk]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports clkTrans]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports dataTrans]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports timebaseRst]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {dataToReg[8]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {dataToReg[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {dataToReg[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {dataToReg[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {dataToReg[4]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {dataToReg[3]}]
...
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[11]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[10]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[9]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[8]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[7]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[6]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[5]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[4]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[3]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[2]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[1]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {countIn[0]}]
