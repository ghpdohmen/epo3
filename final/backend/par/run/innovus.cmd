...
#  Created on Fri Jan 20 21:35:51 2023                
#                                                     
#######################################################
...
editPin -pin R -layer 2 -fixedPin -assign {29.82 0} -side TOP
editPin -pin G -layer 2 -fixedPin -assign {30.38 0} -side TOP
editPin -pin B -layer 2 -fixedPin -assign {30.94 0} -side TOP
editPin -pin V -layer 2 -fixedPin -assign {31.50 0} -side TOP
editPin -pin H -layer 2 -fixedPin -assign {32.06 0} -side TOP
editPin -pin data_switch -layer 2 -fixedPin -assign {32.62 0} -side TOP
editPin -pin clk15k_switch -layer 2 -fixedPin -assign {33.18 0} -side TOP
editPin -pin led0 -layer 2 -fixedPin -assign {33.74 0} -side TOP
editPin -pin led1 -layer 2 -fixedPin -assign {34.30 0} -side TOP
editPin -pin led2 -layer 2 -fixedPin -assign {34.86 0} -side TOP
editPin -pin led3 -layer 2 -fixedPin -assign {35.42 0} -side TOP
editPin -pin led5 -layer 2 -fixedPin -assign {35.98 0} -side TOP
editPin -pin led6 -layer 2 -fixedPin -assign {36.54 0} -side TOP
editPin -pin led7 -layer 2 -fixedPin -assign {37.10 0} -side TOP
editPin -pin led8 -layer 2 -fixedPin -assign {37.66 0} -side TOP
editPin -pin led9 -layer 2 -fixedPin -assign {38.22 0} -side TOP
