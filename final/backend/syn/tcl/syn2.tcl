...
read_hdl -vhdl {flipflop_bufr.vhd}
...
read_hdl -vhdl {flipflop_bufr-behaviour.vhd}
...
read_hdl -vhdl {flipflop_bufr_behav_cfg.vhd}
...
read_hdl -vhdl {logic_top_behaviour_top_cfg.vhd}
