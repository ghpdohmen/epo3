...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Thu Jan 19 09:49:34 CET 2023
...
set_load -pin_load 1.0 [get_ports data_switch]
set_load -pin_load 1.0 [get_ports clk15k_switch]
...
set_load -pin_load 1.0 [get_ports H]
...
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports clk15k_in]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports data_switch]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports clk15k_switch]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports R]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports G]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports B]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports V]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports H]
...
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports clk15k_in]
